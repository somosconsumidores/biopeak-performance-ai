...
import { TrainWithoutWatchesSection } from '@/components/landing/TrainWithoutWatchesSection';
...
// These imports are now used in TrainWithoutWatchesSection component
// Keeping only what's needed in LandingPage
...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* AI Coach Section - New Modern Layout */}
      <TrainWithoutWatchesSection />
