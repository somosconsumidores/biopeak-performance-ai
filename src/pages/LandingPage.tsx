        ...
        <div className="container mx-auto text-center">
          <ScrollReveal>
            <div className="flex justify-center mb-8">
              <img src="https://static.wixstatic.com/media/a025ad_ee60ef288f514496a4a23562f1ad4c03~mv2.png" alt="BioPeak" className="h-40 sm:h-52 md:h-60 lg:h-64 w-auto data-glow" />
            </div>
            ...
            <div className="flex justify-center mb-8">
              <img src="https://static.wixstatic.com/media/a025ad_cf5ff4a4d6074fb7b479925857fd7130~mv2.png" alt="BioPeak Hero" className="max-h-56 sm:max-h-80 w-auto max-w-full object-contain" />
            </div>
