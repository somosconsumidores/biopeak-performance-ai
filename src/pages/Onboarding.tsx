...
export const Onboarding = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex flex-col p-4 touch-manipulation onboarding-container">
      {/* Fixed Header */}
                      ...
                      {ATHLETIC_LEVELS.map((level) => {
                        ...
                        return (
                          <div key={level.id} className="flex items-center space-x-2">
                            ...
                            <Label
                              htmlFor={level.id}
                              className="flex items-start space-x-3 cursor-pointer flex-1 p-3 md:p-4 rounded-lg border border-border hover:bg-muted/50 transition-colors"
                            >
                              <Icon className="h-5 w-5 md:h-6 md:w-6 text-primary mt-1 flex-shrink-0" />
                              <div>
                                <div className="font-medium text-foreground text-sm md:text-base">{level.label}</div>
            ...
            <div className="shrink-0 pt-4 border-t border-border mt-4">
              <div className="flex flex-col sm:flex-row justify-between gap-3">
                <Button
                  ...
                  className="w-full sm:w-auto order-2 sm:order-1 accessible-button touch-target h-12"
                >
                  Voltar
                </Button>
                ...
                {currentStep < totalSteps ? (
                  <Button
                    ...
                    disabled={!canProceed()}
                    className={cn(
                      "w-full sm:w-auto order-1 sm:order-2 accessible-button touch-target h-12",
