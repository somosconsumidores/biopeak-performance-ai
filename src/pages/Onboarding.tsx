...
export const Onboarding = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-start justify-center p-4 py-8 touch-manipulation onboarding-container overflow-y-auto">
